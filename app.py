...
<style>
    ...
    .badge-high { background-color: #10b981; color: white; padding: 0.25rem 0.75rem; border-radius: 2rem; }
    .badge-medium { background-color: #f59e0b; color: white; padding: 0.25rem 0.75rem; border-radius: 2rem; }
    .badge-low { background-color: #ef4444; color: white; padding: 0.25rem 0.75rem; border-radius: 2rem; }
</style>
    ...
    if st.session_state.get('processed', False):
        ...
        for idx, r in enumerate(results[:5], 1):
            ...
            <div class="candidate-card">
                <h3>#{idx} - {c['name']}</h3>
                <p><strong>{c['current_role']}</strong> • {c['experience_years']} years</p>
